...
const mard200=fs.readFileSync('C:/claudecode/_mard_200.js','utf8').trim();
...
'    <label>色板 <span class="val" id="paletteLabel">MARD 200色</span></label>\n'+
...
'      <option value="MARD 200色" selected>🧶 MARD 200色</option>\n'+
'    </select>\n'+
'  </div>';
